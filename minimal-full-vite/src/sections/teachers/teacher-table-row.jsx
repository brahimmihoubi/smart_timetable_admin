...
export function TeacherTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow }) {
  ...
  return (
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell>{row.maxHours}h</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.specializations}</TableCell>
        <TableCell>
